...
import { JOURNEY, ARCHIVES } from "@/data/journeyData";
import {
  GraduationCap,
  Briefcase,
  MapPin,
            ...
            return (
              <div key={i} className="flex flex-col">
                ...
                <div className="space-y-2">
                  {displayItems.map((doc, di) => (
                    <button
                      key={di}
                      onClick={() => setSelectedDoc(doc.file)}
                      className="w-full flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-white/20 transition-all text-left group"
                    >
